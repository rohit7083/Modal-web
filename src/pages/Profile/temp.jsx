...
const ProfilePage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white text-black">
      ...
      {saveSuccess && (
        <div className="fixed top-4 right-4 z-[1300] bg-green-500 text-white px-4 py-3 rounded-lg shadow-lg animate-fade-in">
            ...
            <div className="flex-1 w-full space-y-4">
              ...
              <div className="flex flex-wrap items-center gap-3 justify-between">
                ...
                <button
                  ...
                  className="px-4 py-2 rounded-lg bg-white text-black border border-gray-300 font-medium text-sm transition flex items-center gap-2 hover:bg-gray-50"
                >
                  <svg 
                    className="w-4 h-4" 
                    fill="none" 
              ...
              <div className="grid md:grid-cols-[2fr,1.3fr] gap-4 text-sm">
                <div>
                  ...
                  {/* Display saved links from API response */}
                ...
                <div className="grid grid-cols-2 gap-3 text-xs md:text-sm">
                  ...
                  <div className="bg-slate-50 rounded-xl p-3">
                    ...
                    <p className="font-semibold text-gray-900">{basic.gender ?? "—"}</p>
                  </div>
                  <div className="bg-slate-50 rounded-xl p-3">
                    <p className="text-gray-500">Languages</p>
                    <p className="font-semibold text-gray-900">{professional?.languages?.length ? professional.languages.join(", ") : "—"}</p>
                  </div>
                  <div className="bg-slate-50 rounded-xl p-3">
              ...
              <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 pt-2 border-t border-gray-100">
                ...
                <div className="flex flex-wrap gap-2 text-[11px]">
                  <button
                    ...
                    className="px-4 py-2 rounded-lg bg-white text-black border border-gray-300 font-medium text-sm transition hover:bg-gray-50 flex items-center gap-2"
                  >
      ...
      <LinkModal
        ...
        initialLinks={socialLinks.map(link => ({ platform: link.platform, url: link.url }))}
